...
// Propagate U that was previously solved in K [U] = F
void StaticODESolver::propagate_position_increment(const sofa::core::MechanicalParams &mechanical_parameters,
                                                   const sofa::core::behavior::MultiMatrixAccessor & matrix_accessor,
